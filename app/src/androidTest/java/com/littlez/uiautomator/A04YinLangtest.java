...
public class A04YinLangtest extends TestCase {
    ...
    public void test() throws UiObjectNotFoundException {
        ...
        try {
            ...
            while (appRun) {
                UiObject uiWithdraw = new UiObject(new UiSelector().resourceId("com.video.yl:id/layout_withdraw"));//提现栏
                ...
                if (uiWithdraw.exists()) {//是首页
                    ...
                    UiObject uiHome = new UiObject(new UiSelector().resourceId("com.video.yl:id/tab_text").text("首页"));
                    uiHome.click();
                    ...
                    UiObject uiPrivacy = new UiObject(new UiSelector().resourceId("sdf"));
